...
ex.plot(x='global_step', y="charts/avg_episodic_return", rolling=50,
    n_samples=400, legend=False, err_fn=None,
    # err_style="fill",
    suptitle="", title=y_names[0],
    representative_fn=repr_fn, ax=g[y_names[0]])
ex.plot(x='global_step', y="charts/avg_episodic_return", rolling=50,
    n_samples=400, legend=False, err_fn=None,
    err_style="fill",
    suptitle="", title=y_names[1],
    representative_fn=repr_fn, ax=g[y_names[1]])
ex.plot(x='global_step', y="charts/avg_episodic_return", rolling=50,
    n_samples=400, legend=False, err_fn=lambda h: h.grouped.sem(),
    err_style="fill",
    title=y_names[2],
    suptitle="", ax=g[y_names[2]])
for ax in g:
